...
namespace spvgentwo
{
	...
	namespace ModulePrinter
	{
		namespace detail
		{
			...
			inline const char* PushRed = (char*)u8"\x1B[31m";
			inline const char* PushGreen = (char*)*u8"\x1B[32m";
			inline const char* PushYellow = (char*)u8"\x1B[33m";
			inline const char* PushBlue = (char*)u8"\x1B[34m";
			inline const char* PushPurple = (char*)u8"\x1B[35m";
			inline const char* PushLightBlue = (char*)u8"\x1B[36m";
			inline const char* PushWhite = (char*)u8"\x1B[97m";
			inline const char* PushRedBG = (char*)u8"\x1B[41m";
			inline const char* PopGrey = (char*)u8"\033[0m";
		}
