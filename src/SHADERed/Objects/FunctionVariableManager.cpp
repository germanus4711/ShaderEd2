...
namespace ed {
	...
	void FunctionVariableManager::Update(ed::ShaderVariable* var)
	{
		...
		if (var->Function == FunctionShaderVariable::Pointer) {
			...
			case FunctionShaderVariable::None: break;
			case FunctionShaderVariable::Pointer: break;
			case FunctionShaderVariable::CameraSnapshot: break;
			case FunctionShaderVariable::ObjectProperty: break;
			case FunctionShaderVariable::MatrixRotationRollPitchYaw: break;
			case FunctionShaderVariable::ScalarCos: break;
			case FunctionShaderVariable::ScalarSin: break;
			case FunctionShaderVariable::VectorNormalize: break;
			case FunctionShaderVariable::PluginFunction: break;
			case FunctionShaderVariable::Count: break;
			}
			...
			case FunctionShaderVariable::CameraSnapshot: break;
			case FunctionShaderVariable::ObjectProperty: break;
			case FunctionShaderVariable::MatrixIdentity: break;
			case FunctionShaderVariable::MatrixLookAtLH: break;
			case FunctionShaderVariable::MatrixLookToLH: break;
			case FunctionShaderVariable::MatrixOrthographicLH: break;
			case FunctionShaderVariable::MatrixPerspectiveFovLH: break;
			case FunctionShaderVariable::MatrixPerspectiveLH: break;
			case FunctionShaderVariable::MatrixRotationAxis: break;
			case FunctionShaderVariable::MatrixRotationNormal: break;
			case FunctionShaderVariable::MatrixRotationRollPitchYaw: break;
			case FunctionShaderVariable::MatrixRotationX: break;
			case FunctionShaderVariable::MatrixRotationY: break;
			case FunctionShaderVariable::MatrixRotationZ: break;
			case FunctionShaderVariable::MatrixScaling: break;
			case FunctionShaderVariable::MatrixTranslation: break;
			case FunctionShaderVariable::VectorNormalize: break;
			case FunctionShaderVariable::PluginFunction: break;
			case FunctionShaderVariable::Count: break;
			}
	...
	bool FunctionVariableManager::HasValidReturnType(ShaderVariable::ValueType ret, ed::FunctionShaderVariable func)
	{
		...
		if (func >= FunctionShaderVariable::ScalarCos && func <= FunctionShaderVariable::ScalarSin)
			return ret == ShaderVariable::ValueType::Float1;
		if (func == FunctionShaderVariable::VectorNormalize)
			return ret > ShaderVariable::ValueType::Float1 && ret <= ShaderVariable::ValueType::Float4;
		if (func == FunctionShaderVariable::CameraSnapshot)
			return ret == ShaderVariable::ValueType::Float4x4;
		if (func == FunctionShaderVariable::Pointer)
			return true;
