...
namespace ed {
	...
	public:
		...
		inline int GetCurrentLine() { return spvm_program_get_language(m_shader) == SpvSourceLanguageHLSL ? (m_vm->current_line - 1) : m_vm->current_line; }
	...
	private:
		std::unordered_map<spvm_image*, GLuint> m_imageToTextureID;
		...
		std::vector<spvm_image> m_images; // TODO: clear these + smart cache
