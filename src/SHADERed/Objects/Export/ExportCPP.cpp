...
namespace ed {
	...
	std::string getSystemVariableName(ed::ShaderVariable* var)
	{
		...
		case SystemShaderVariable::IsPicked: break;
		case SystemShaderVariable::IsSavingToFile: break;
		case SystemShaderVariable::CameraPosition: break;
		case SystemShaderVariable::CameraPosition3: break;
		case SystemShaderVariable::CameraDirection3: break;
		case SystemShaderVariable::KeysWASD: break;
		case SystemShaderVariable::Mouse: break;
		case SystemShaderVariable::MouseButton: break;
		case SystemShaderVariable::PickPosition: break;
		case SystemShaderVariable::PluginVariable: break;
