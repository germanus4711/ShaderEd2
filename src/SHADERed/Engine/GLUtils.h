...
namespace ed::gl {
	...
	void CreateBufferVAO(GLuint& geoVAO, GLuint geoVBO, const std::vector<ed::ShaderVariable::ValueType>& ilayout, GLuint bufVBO = 0, const std::vector<ed::ShaderVariable::ValueType>& types = std::vector<ed::ShaderVariable::ValueType>());
	void CreateVAO(GLuint& geoVAO, GLuint geoVBO, const std::vector<InputLayoutItem>& ilayout, GLuint geoEBO = 0, GLuint bufVBO = 0, const std::vector<ed::ShaderVariable::ValueType>& types = std::vector<ed::ShaderVariable::ValueType>());
