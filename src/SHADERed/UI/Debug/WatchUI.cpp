...
namespace ed {
	void DebugWatchUI::Refresh() const
	{
	...
	void DebugWatchUI::Update(float delta)
	{
		...
		if (ImGui::BeginTable("##watches_tbl", 2, ImGuiTableFlags_Resizable | ImGuiTableFlags_ScrollFreezeTopRow | ImGuiTableFlags_ScrollY,
			ImVec2(0, Settings::Instance().CalculateSize(-ImGui::GetFontSize() - 10.0f)))) {
