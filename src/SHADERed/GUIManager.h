...
#define getByte(value, n) (value >> (n * 8) & 0xFF)
	...
	public:
		...
		[[nodiscard]] SDL_Window* GetSDLWindow() const { return m_wnd; }
		...
		void CreateNewImage3D() { m_isCreateImg3DOpened = true; }
		void CreateNewCameraSnapshot() { m_isRecordCameraSnapshotOpened = true; }
		void CreateKeyboardTexture() { m_isCreateKBTxtOpened = true; }
		void CreateNewComputePass();
		void CreateNewAudioPass();

		[[nodiscard]] bool IsPerformanceMode() const { return m_performanceMode; }
		void SetPerformanceMode(bool mode) { m_perfModeFake = mode; }
		[[nodiscard]] bool IsMinimalMode() const { return m_minimalMode; }
		void SetMinimalMode(bool mode) { m_minimalMode = mode; }
		[[nodiscard]] bool IsFocusMode() const { return m_focusMode; }
		void SetFocusMode(bool mode) { m_focusMode = mode; }
